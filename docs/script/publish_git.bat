...
echo Backing up static docs files...
if exist "%TARGET%\index.html" copy /Y "%TARGET%\index.html" "%TEMP%\qrep_index.html" >nul
if exist "%TARGET%\qreports.cer" copy /Y "%TARGET%\qreports.cer" "%TEMP%\qreports.cer" >nul
...
echo Restoring static docs files...
if exist "%TEMP%\qrep_index.html" copy /Y "%TEMP%\qrep_index.html" "%TARGET%\index.html" >nul
if exist "%TEMP%\qreports.cer" copy /Y "%TEMP%\qreports.cer" "%TARGET%\qreports.cer" >nul
